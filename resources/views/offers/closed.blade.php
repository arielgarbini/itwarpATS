...
@section('page-header')
	<h1>
		Listado de Ofertas Cerradas
		<small></small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="/"><i class="fa fa-dashboard"></i> Inicio</a></li>
		<li class="active">Ofertas Cerradas</li>
	</ol>
@endsection
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading"><b>Ofertas Cerradas</b>
				</div>
				<div class="panel-body">
					...
					<table class="table table-hover" id="simpleTable">
						...
						<tbody>
							...
							<tr>
								<td><span class="circulo_status" title="{{$offer->status->status}}" style="background: {{$offer->status->color}}; border: 3px solid {{$offer->status->color}}; @if($offer->status->color=='#151515') color:white; @endif">{{$offer->status->nro}}</span></td>
								...
								<td><a href= "/candidates/{{$offer->id}}" class="btn btn-warning" >Candidatos</a>&nbsp;&nbsp;<a href= "/offerComments/{{$offer->id}}" class="btn btn-primary" >Comentarios</a> @if(Auth::user()->roles_id==1 || Auth::user()->id==$offer->created_by)&nbsp;&nbsp;
 ...
 @endif
							...
							<tr>
								...
								<td><a href= "/candidates/{{$offer->offer->id}}" class="btn btn-warning" >Candidatos</a>&nbsp;&nbsp;<a href= "/offerComments/{{$offer->offer->id}}" class="btn btn-primary" >Comentarios</a>@if(Auth::user()->roles_id==1 || Auth::user()->id==$offer->offer->created_by)&nbsp;&nbsp;
